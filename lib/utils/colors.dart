...
class AppColors{
  ...
  static final Color testColor = const Color(0xFFccc9d3);
  ...
  static final Color iconColor3 = const Color(0xff88fc9b);
  static final Color paraColor = const Color(0xFF8fa37f);
